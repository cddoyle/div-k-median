...
def test_k_median_k_partitions_LS(N, d, k):
    #N=100
    #d=2
    #k=3
    data, _ = make_blobs(n_samples=N,
    ...
    # LS_1 using complete data
    stats = k_median_k_partitions_LS(E, data, None, N, d, k, is_coreset=False)
    pprint(stats)

    # LS_1 using coresets
    stats = k_median_k_partitions_LS_mk1(E, coreset, weights, N, d, k)
    pprint(stats)
#end test_k_median_k_partitions_LS()

if __name__ == '__main__':
    test_k_median_k_partitions_LS(1000, 5, 4)
